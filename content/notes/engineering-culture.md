...
8. Take notes and write down everything. (I encourage PKM nerds to do their
   thing)
9. Classic be a leader not a manager idea. Lead by example.
10. Respect other's time. Super important especially when not all time is [[engineering-culture#the-37-signals| the same]]
11. Always be learning. If we want the ICs to do this it needs to start from the
    top.
12. Be able to log off and take time away.
13. Make sure metrics are meaningful. Be careful of [Goodhart's Law](https://coffeeandjunk.com/goodharts-campbells-law/#:~:text=%E2%80%9CWhen%20a%20measure%20becomes%20a,to%20be%20a%20good%20measure.%E2%80%9D&text=All%20metrics%20of%20evaluation%20are,people%20start%20to%20game%20it.)
14. Actually care about people
...
- Don't shy away from making estimates and are always trying to get better at
  it. - You need to be comfortable working with some nonzero amount of uncertainty
  and risk
...
- Understand the difference between mentorship and sponsorship and work towards
  the latter. - Instead of focusing on helping underrepresented/underprivileged members of
...
## Sources I Found Later

Using this section to keep track of links and sources that I've found well after
looking through all of these, but didn't have the time to immediately look
through. More so I can clear my [[browsing hydra|Browsing Hydra]]

- http://algeri-wong.com/yishan/engineering-management.html
- https://katemats.com/leadership/
